package S05T02F02TortosadelaIglesiaIsmael.controllers;
...
import S05T02F02TortosadelaIglesiaIsmael.model.repository.UsuarioRepository;
import S05T02F02TortosadelaIglesiaIsmael.model.services.IUsuarioServicesDAO;
...
@Slf4j //implementación abstracta de logging
@Controller
...
public class UsuarioController {
    ...
    public ResponseEntity<?> updateUsuario(@PathVariable("id") String id, @RequestBody UsuarioDTO usuarioDTO){
        try {
    ...
    public ResponseEntity <JugadaEntity> partidaDados (@PathVariable("id") String id){
        try {
    ...
    public ResponseEntity<?> deleteJugada(@PathVariable("id") String id ) {
        try {
    ...
    public ResponseEntity<?> getOneJugador(@PathVariable("id") String id) {
        try {
